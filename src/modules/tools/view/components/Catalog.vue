...
export default {
  ...
  computed: {
    ViewToolStore() {
      return ViewToolStore
    },
    ...mapGetters('ViewToolStore', ['parentCatalog']),
    isTableShown() {
  ...
  methods: {
    ...mapMutations('ViewToolStore', ['setParentCatalog']),
    ...mapActions('ViewToolStore', ['fetchToolsByFilter']),
